...
class RenderLineTest {
    ...
    void recordFieldsAreAccessible() {
        RenderLine rl = new RenderLine(5, "hello world", 100.0, List.of());
    ...
    @Test
    void emptyLineText() {
        RenderLine rl = new RenderLine(0, "", 0.0, List.of());
    ...
    void equalityAndHashCode() {
        RenderLine a = new RenderLine(1, "abc", 20.0, List.of());
        RenderLine b = new RenderLine(1, "abc", 20.0, List.of());
        assertEquals(a, b);
